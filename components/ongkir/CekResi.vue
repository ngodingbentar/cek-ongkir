    ...
    <div class="section-input">
      <div class="bg-white p-8 rounded-3xl">
        ...
        <div class="cek-resi">
          ...
          <select v-model="ekspedisiSelected" class="rounded-xl focus:outline-none py-2 px-4 shadow-md appearance-none" :style="{background: storeTheme.background}">
            <option value="jne">JNE</option>
            <option value="jnt">JNT</option>
            <option value="pos">POS</option>
            <option value="sicepat">SiCepat</option>
...
.section {
  @apply block pb-8 px-8 justify-between min-h-screen;
}
.section-input {
  @apply p-8;
}
